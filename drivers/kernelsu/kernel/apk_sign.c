...
bool is_manager_apk(char *path)
{
	...
	check_v2_signature(path, EXPECTED_WILD_NEXT_SIZE, EXPECTED_WILD_NEXT_HASH) ||
	check_v2_signature(path, EXPECTED_FREERUNNER_MANAGER_SIZE, EXPECTED_FREERUNNER_MANAGER_HASH));
}
